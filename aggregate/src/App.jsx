      ...
      <Table>
        ...
        <Table.Body className="divide-y">
          {students.map((student) => (
            <Table.Row key={student.student_id} className="bg-white dark:border-gray-700 dark:bg-gray-800">
              <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white">
                {student.student_id}
              </Table.Cell>
              <Table.Cell>{student.student_nom}</Table.Cell>
              <Table.Cell>{student.student_prenom}</Table.Cell>
